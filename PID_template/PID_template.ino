...
void update(){
  ...
  float prop = error * kp;
  integral += error * INTERVAL*0.001 * ki;
  float derivative = (error - prev_err) * kd / INTERVAL /0.001;
  prev_err = error;
...
{
  int speed1 = round(speedFloat);
  speed1 = speed1 > 255 ? 255 : speed1;
  speed1 = speed1 < -255 ? -255 : speed1;
  speed1 = speed1 >= -1 && speed1<0 ? 0 : speed1;
  speed1 = speed1 <= 1 && speed1>0 ? 0 : speed1;
  speed1 = speed1 > -38 && speed1<0 ? -38 : speed1;
  speed1 = speed1 < 38 && speed1>0 ? 38 : speed1;
  int dir = sign(speed1);
